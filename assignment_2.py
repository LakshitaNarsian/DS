...
class LinkedList: 
    ...
    def reverse_display(self):
        if self.size == 0:
            print("No element")
            return None
        last = dl_list.get_tail()
        print(last.element)
        while last.previous:
            if type(last.previous.element) == type(dl_list.head):
    ...
    def get_previous_node_at(self,index):
        if index == 0:
            ...
            return None
        return dl_list.get_node_at(index).previous
...
dl_list.add_tail('13')
dl_list.add_tail('14')
dl_list.get_head().element.element
dl_list.add_between_list(2,'Element between')
dl_list.remove_between_list(2)

dl_list2 = LinkedList()
l2 = Node('15')
dl_list2.add_head(l2)
dl_list2.add_tail('98')
dl_list2.add_tail('120')
dl_list2.add_tail('36')
dl_list.merge(dl_list2)
dl_list.get_previous_node_at(3).element
dl_list.reverse_display()
